...
def build_longfellow_tree() -> FamilyTree:
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-sr", child_id="william-longfellow-1650")
    )
    tree.add_relationship(
        Relationship(parent_id="elizabeth-thornton", child_id="william-longfellow-1650")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1650", child_id="william-longfellow-1679")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1650", child_id="stephen-longfellow-1681")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1650", child_id="anna-longfellow-1683")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1650", child_id="stephen-longfellow-1685")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1650", child_id="elizabeth-longfellow-1688")
    )
    tree.add_relationship(
        Relationship(parent_id="anne-sewall", child_id="elizabeth-longfellow-1688")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1650", child_id="nathan-longfellow-1690")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="nathan-longfellow-1690", child_id="jonathan-longfellow-1714")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="william-longfellow-1714")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="william-longfellow-1714")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="anne-longfellow-1716")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="anne-longfellow-1716")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="edward-longfellow-1718")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="edward-longfellow-1718")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="sarah-longfellow-1721")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="sarah-longfellow-1721")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="stephen-longfellow-1723")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="stephen-longfellow-1723")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1723", child_id="stephen-longfellow-1750")
    )
    tree.add_relationship(
        Relationship(parent_id="tabitha-bragdon", child_id="stephen-longfellow-1750")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1750", child_id="stephen-longfellow-1776")
    )
    tree.add_relationship(
        Relationship(parent_id="patience-young", child_id="stephen-longfellow-1776")
    )
    ...
    tree.add_relationship(
        Relationship(
            parent_id="stephen-longfellow-1776", child_id="henry-wadsworth-longfellow-1807"
        )
    )
    tree.add_relationship(
        Relationship(parent_id="zilpah-wadsworth", child_id="henry-wadsworth-longfellow-1807")
    )
    ...
    tree.add_relationship(
        Relationship(
            parent_id="henry-wadsworth-longfellow-1807", child_id="charles-longfellow-1844"
        )
    )
    tree.add_relationship(
        Relationship(parent_id="fanny-appleton", child_id="charles-longfellow-1844")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="henry-wadsworth-longfellow-1807", child_id="ernest-longfellow-1845")
    )
    tree.add_relationship(
        Relationship(parent_id="fanny-appleton", child_id="ernest-longfellow-1845")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="henry-wadsworth-longfellow-1807", child_id="fanny-longfellow-1847")
    )
    tree.add_relationship(
        Relationship(parent_id="fanny-appleton", child_id="fanny-longfellow-1847")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="henry-wadsworth-longfellow-1807", child_id="alice-longfellow-1850")
    )
    tree.add_relationship(
        Relationship(parent_id="fanny-appleton", child_id="alice-longfellow-1850")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="henry-wadsworth-longfellow-1807", child_id="edith-longfellow-1853")
    )
    tree.add_relationship(
        Relationship(parent_id="fanny-appleton", child_id="edith-longfellow-1853")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="henry-wadsworth-longfellow-1807", child_id="anne-longfellow-1855")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="samuel-longfellow-1725")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="samuel-longfellow-1725")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="abigal-longfellow-1727")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="abigal-longfellow-1727")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1685", child_id="elizabeth-longfellow-1732")
    )
    tree.add_relationship(
        Relationship(parent_id="abigail-thompson", child_id="elizabeth-longfellow-1732")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="ann-b-longfellow-1742")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="ann-b-longfellow-1742")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="nathan-longfellow-1744")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="nathan-longfellow-1744")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="stephen-longfellow-1746")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="stephen-longfellow-1746")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="jane-longfellow-1749")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="jane-longfellow-1749")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="abigail-longfellow-1752")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="abigail-longfellow-1752")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="william-longfellow-1755")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="william-longfellow-1755")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="samuel-longfellow-1758")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="samuel-longfellow-1758")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="william-longfellow-1714", child_id="benjamin-longfellow-1761")
    )
    tree.add_relationship(
        Relationship(parent_id="hepsibah-plumer", child_id="benjamin-longfellow-1761")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="jane-longfellow-1773")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="mary-longfellow-1774")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="lydia-longfellow-1777")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-pritchard", child_id="lydia-longfellow-1777")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="stephen-longfellow-1779")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-pritchard", child_id="stephen-longfellow-1779")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="john-longfellow-1781")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="samuel-longfellow-1784")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-pritchard", child_id="samuel-longfellow-1784")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="david-longfellow-1786")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-pritchard", child_id="david-longfellow-1786")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="sewall-longfellow-1789")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-pritchard", child_id="sewall-longfellow-1789")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="stephen-longfellow-1746", child_id="patty-g-longfellow-1792")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-pritchard", child_id="patty-g-longfellow-1792")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-longfellow-1781", child_id="john-longfellow-1804")
    )
    tree.add_relationship(
        Relationship(parent_id="lydia-brown-longfellow", child_id="john-longfellow-1804")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-longfellow-1781", child_id="lydia-longfellow-1807")
    )
    tree.add_relationship(
        Relationship(parent_id="lydia-brown-longfellow", child_id="lydia-longfellow-1807")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-longfellow-1781", child_id="samuel-longfellow-1813")
    )
    tree.add_relationship(
        Relationship(parent_id="lydia-brown-longfellow", child_id="samuel-longfellow-1813")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-longfellow-1781", child_id="mary-j-longfellow-1818")
    )
    tree.add_relationship(
        Relationship(parent_id="lydia-brown-longfellow", child_id="mary-j-longfellow-1818")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-longfellow-1804", child_id="mary-e-longfellow-1826")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-longfellow-1804", child_id="john-r-longfellow-1828")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-r-longfellow-1828", child_id="john-longfellow-1848")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-brown-longfellow", child_id="john-longfellow-1848")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-r-longfellow-1828", child_id="john-h-longfellow-1850")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-brown-longfellow", child_id="john-h-longfellow-1850")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-r-longfellow-1828", child_id="mary-r-longfellow-1852")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-brown-longfellow", child_id="mary-r-longfellow-1852")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-r-longfellow-1828", child_id="albert-longfellow-1854")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-brown-longfellow", child_id="albert-longfellow-1854")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-r-longfellow-1828", child_id="george-longfellow-1854")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-brown-longfellow", child_id="george-longfellow-1854")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-r-longfellow-1828", child_id="walter-longfellow-1860")
    )
    tree.add_relationship(
        Relationship(parent_id="mary-brown-longfellow", child_id="walter-longfellow-1860")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="albert-r-longfellow-1875")
    )
    tree.add_relationship(
        Relationship(parent_id="helen-preme", child_id="albert-r-longfellow-1875")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="samuel-h-longfellow-1876")
    )
    tree.add_relationship(
        Relationship(parent_id="helen-preme", child_id="samuel-h-longfellow-1876")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="chester-longfellow-1883")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="chester-longfellow-1883")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="mildred-rena-longfellow-1885")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="mildred-rena-longfellow-1885")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="harry-b-longfellow-1886")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="harry-b-longfellow-1886")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="margaret-m-longfellow-1889")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="margaret-m-longfellow-1889")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="john-c-longfellow-1891")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="john-c-longfellow-1891")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="helen-v-longfellow-1894")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="helen-v-longfellow-1894")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="john-h-longfellow-1850", child_id="clarence-r-longfellow-1900")
    )
    tree.add_relationship(
        Relationship(parent_id="viola-cambelle", child_id="clarence-r-longfellow-1900")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-rena-longfellow-1885", child_id="mildred-e-parkinson-1906")
    )
    tree.add_relationship(
        Relationship(parent_id="lindley-parkinson-sr", child_id="mildred-e-parkinson-1906")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-rena-longfellow-1885", child_id="lindley-parkinson-jr")
    )
    tree.add_relationship(
        Relationship(parent_id="lindley-parkinson-sr", child_id="lindley-parkinson-jr")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-rena-longfellow-1885", child_id="margaret-a-parkinson-1917")
    )
    tree.add_relationship(
        Relationship(parent_id="lindley-parkinson-sr", child_id="margaret-a-parkinson-1917")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-e-parkinson-1906", child_id="sterling-walters-jr")
    )
    tree.add_relationship(
        Relationship(parent_id="sterling-walters-sr", child_id="sterling-walters-jr")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-e-parkinson-1906", child_id="merle-lindley-walters")
    )
    tree.add_relationship(
        Relationship(parent_id="sterling-walters-sr", child_id="merle-lindley-walters")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-e-parkinson-1906", child_id="wayne-luther-walters")
    )
    tree.add_relationship(
        Relationship(parent_id="sterling-walters-sr", child_id="wayne-luther-walters")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="mildred-e-parkinson-1906", child_id="glen-robert-walters")
    )
    tree.add_relationship(
        Relationship(parent_id="sterling-walters-sr", child_id="glen-robert-walters")
    )
    ...
    tree.add_person(
        Person(
            ...
            notes=(
                "Wife of Lindley Ambrose Parkinson Jr. Resided in Anoka, Anoka County, Minnesota."
            ),
        )
    )
    tree.add_union(
    ...
    tree.add_relationship(
        Relationship(parent_id="lindley-parkinson-jr", child_id="lindley-parkinson-iii")
    )
    tree.add_relationship(
        Relationship(parent_id="helen-may-hornsby", child_id="lindley-parkinson-iii")
    )
    ...
    tree.add_relationship(
        Relationship(parent_id="lindley-parkinson-jr", child_id="kay-parkinson-1947")
    )
    tree.add_relationship(
        Relationship(parent_id="helen-may-hornsby", child_id="kay-parkinson-1947")
    )
