...
EXTERNAL = {
    ...
    "Math", "JSON", "Object", "Array", "Set", "Map", "Date", "String", "Number",
    "Boolean", "parseInt", "parseFloat", "isNaN", "RegExp", "Error", "alert",
    "confirm", "prompt", "navigator", "location", "history", "URL",
    "URLSearchParams", "FormData", "Blob", "FileReader", "Image", "atob", "btoa",
    "requestAnimationFrame", "encodeURIComponent", "decodeURIComponent",
    "d3", "L", "google", "structuredClone", "CustomEvent", "Event",
}
